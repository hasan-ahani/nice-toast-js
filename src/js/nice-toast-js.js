...
(function (factory) {
   ...
   "use strict";
    $('body').append(
        $('<div />').append([
            $('<div />').append(
                $('<div />').addClass('nice-toast-wrapper top-left')
            ),
            $('<div />').append(
                $('<div />').addClass('nice-toast-wrapper top-center')
            ),
            $('<div />').append(
                $('<div />').addClass('nice-toast-wrapper top-right')
            ),
            $('<div />').append(
                $('<div />').addClass('nice-toast-wrapper bottom-left')
            ),
            $('<div />').append(
                $('<div />').addClass('nice-toast-wrapper bottom-center')
            ),
            $('<div />').append(
                $('<div />').addClass('nice-toast-wrapper bottom-right')
            ),
        ])
    );
